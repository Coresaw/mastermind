...
#widget to separate games and display a victory message
...
#widget to display a specific guess as well as the clues associated with it
...
#class for the scrollable display
...
class Window(QMainWindow):
    def __init__(self):
        ...
        #placeholder for the clues to be displayed for a guess
        self.Cluenumbers = []
        #placeholder for the solution to the puzzle
        self.mastersolution = []
        ...
        self.UiComponents()
        self.InitWindow()
        #variable to display who solved the puzzle in the victory message
        self.agent = "player"
        #variable to display the number of steps taken in the victory message
        self.totalSteps = 0
    ...
    def UiComponents(self):
        ...
        #invisible widget to keep the display structured
    ...
    #function to determine the clues to be displayed
    ...
    #when play button is clicked, activate various buttons and generate a code to be cracked
    ...
    #function to display a guess and a victory message if necessary
    def AddRow(self):
        self.totalSteps += 1
    ...
    #when player submits a guess, lock out the algorithms and display the guess along with the clues
    ...
    #clear the display and add new ghostwidget to keep the display structured
